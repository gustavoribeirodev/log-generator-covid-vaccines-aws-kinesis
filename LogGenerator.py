#Gerador de logs das vacinas COVID19 pelo mundo que será enviado pra AWS Kinesis Delivery Stream
...
def MakeLog(startLine, numLines):
    destData = time.strftime("/var/log/covidlog/%Y%m%d-%H%M%S.log")
